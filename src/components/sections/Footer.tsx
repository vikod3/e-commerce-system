  ...
  return (
    <footer className="text-white pb-20 pt-16 relative bg-zinc-900">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 mb-12">
          <div className="items-start flex-col justify-start flex gap-14">
            <a className="inline-block max-w-full text-zinc-900" href="https://www.tryeden.com/">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="items-start flex-col justify-start flex gap-6">
              ...
              <ul className="items-start flex-col justify-start flex list-none mb-3 gap-6">
                <li className="list-item">About Eden</li>
                <li className="list-item">Eden Health Club</li>
                <li className="list-item">Eden Pharmacy</li>
                <li className="list-item">Eden Meals</li>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <ul className="flex flex-wrap items-center justify-center lg:justify-start list-none gap-4">
            <li className="list-item">
              <a className="items-center justify-center inline-block max-w-full" href="https://www.facebook.com/TryEdenHealth">
            ...
            <li className="list-item">
              <a className="items-center justify-center inline-block max-w-full" href="https://www.instagram.com/tryedennow">
                <div className="items-center cursor-pointer justify-center flex">
                  <svg className="w-6 h-6" fill="none" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="list-item">
              <a className="items-center justify-center inline-block max-w-full" href="https://x.com/try_eden">
                <div className="items-center cursor-pointer justify-center flex">
                  <svg className="w-6 h-6" fill="none" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="list-item">
              <a className="items-center justify-center inline-block max-w-full" href="https://www.tiktok.com/@tryeden">
                <div className="items-center cursor-pointer justify-center flex">
                  <svg className="w-6 h-6" fill="none" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="list-item">
              <a className="items-center justify-center inline-block max-w-full" href="https://www.linkedin.com/company/tryeden/">
                <div className="items-center cursor-pointer justify-center flex">
                  <svg className="w-6 h-6" fill="none" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="list-item">
              <a className="items-center justify-center inline-block max-w-full" href="https://www.youtube.com/@TryEden">
                <div className="items-center cursor-pointer justify-center flex">
                  <svg className="w-6 h-6" fill="none" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="bg-white/[0.1] items-center bottom-0 justify-center left-0 py-2 px-4 absolute right-0 text-center flex text-sm">
        <div>© 2025 Eden Health International Inc. All rights reserved.</div>
      </div>
    </footer>
  );
};
